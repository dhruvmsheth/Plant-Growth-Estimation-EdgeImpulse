...
def call_otsu_threshold(img_title="/home/pi/Downloads/Downloads/Biomass/CNN/lettuce/lettuce11.jpg", is_reduce_noise=False):
    ...
    crop_img = image_result[32:96, 32:96]

    black = np.sum(crop_img == 0)
    white = np.sum(crop_img == 255)
    
    print(black*0.0265, "cm2 area of plant")
    print(white*0.0265)
